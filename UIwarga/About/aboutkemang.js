...
import myImage from "../Rectangle 123791.png";
    ...
    <Container>
      ...
      <Box sx={{ p: 4 }}>
        ...
        <Typography variant="body1" paragraph>
          RW 36 Kemang Pratama Bekasi merupakan salah satu lingkungan perumahan
          yang berada di kawasan Bekasi, tepatnya di daerah Kemang Pratama, yang
          dikenal sebagai salah satu kawasan perumahan elit di Bekasi. Berikut
          ini adalah gambaran umum mengenai profil RW 36 di Kemang Pratama
          Bekasi:
        </Typography>
        ...
        <Box>
          ...
          <Typography variant="body3" paragraph sx={{ ml: 2 }}>
            ...
            merupakan kawasan perumahan dengan akses mudah ke berbagai fasilitas
            umum seperti pusat perbelanjaan, sekolah, rumah sakit, dan akses
            tol.
          </Typography>
        </Box>
        ...
        <Box>
          ...
          <Typography variant="body3" paragraph sx={{ ml: 2 }}>
            ...
            seperti kolam renang pribadi, taman yang luas, dan desain arsitektur
            yang mew
          </Typography>
        </Box>
        ...
        <Box>
          ...
          <Typography variant="body3" paragraph sx={{ ml: 2, mb: 1 }}>
            ...
            yang berjaga 24 jam dan sistem keamanan yang canggih, termasuk CCTV
            di berbagai sudut.
          </Typography>
        </Box>
        <Box>
          ...
          <Typography variant="body3" paragraph sx={{ ml: 2, mb: 1 }}>
            ...
            Kegiatan perayaan hari-hari besar nasional dan keagamaan juga rutin
            dilakukan, seperti perayaan 17 Agustus, Idul Fitri, dan Natal.
          </Typography>
        </Box>
        ...
        <Box>
          ...
          <Typography variant="body3" paragraph sx={{ ml: 2 }}>
            ...
            RW 36 dipimpin oleh seorang Ketua RW yang dipilih oleh warga melalui
            mekanisme musyawarah atau pemilihan. Di bawah Ketua RW, ada beberapa
            Ketua RT yang mengkoordinasikan kegiatan di tingkat RT
            masing-masing.
          </Typography>
          <Typography variant="body3" paragraph sx={{ ml: 2, mb: 1 }}>
            <span>
            ...
            sosial, dan keagamaan, yang semuanya bekerja sama untuk menciptakan
            lingkungan yang nyaman dan aman bagi warga.
          </Typography>
        </Box>
        ...
        <Box>
          ...
          <Typography variant="body3" paragraph sx={{ ml: 2 }}>
            ...
            lingkungan ini, dengan adanya taman-taman kecil di sekitar rumah dan

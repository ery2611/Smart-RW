...
const data = [
  // Your data array
  {
    id: 1,
    media: Rumput,
    judul_pengaduan: "Rumput yang belum dipotong di Masjid Baitul Jihad",
    alamat: "Masjid Baitul Jihad, jalan Kemang Pratama Blok Z",
    ...
    <div>
      ...
      >
        ...
        <Button
          ...
          color="primary"
          onClick={() => {
            Navigate("/Warga/FormPemotonganRumput");
          }}
          sx={{
...
export default PemotonganRumput;

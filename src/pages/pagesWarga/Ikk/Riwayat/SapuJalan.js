...
import Sapu from "../../../../assets/SapuJalan.png";
...
const data = [
  // Your data array
  {
    id: 1,
    media: Sapu,
    judul_pengaduan: "Jalanan sekitar Kemang Pratama 2 kotor",
    alamat: "Kemang Pratama 2, RW 36",
    ...
    <div>
      ...
      >
        ...
        <Button
          variant="contained"
          color="primary"
          onClick={() => Navigate("/Warga/FormSapuJalan")}
          sx={{

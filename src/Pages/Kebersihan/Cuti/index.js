      ...
      >
        ...
        <Stack direction="column" textAlign="left">
          ...
          <Box sx={{ display: "fluid", justifyContent: "end" }}>
            <Stack>
            <Typography textAlign="end">{hari}, {tanggal}/{bulan}/{tahun}</Typography>
            </Stack>
            <Box
              sx={{ width: "100%", display: "flex", justifyContent: "center" }}
            >
              <Typography variant="body1">JADWAL CUTI PETUGAS KEBERSIHAN HARI INI</Typography>
            </Box>
          </Box>
        </Stack>
              ...
              {currentData.map((row) => (
                ...
                sx={{
                  ...
                  borderBottom: "none",
                    ...
                    <TableCell sx={{paddingRight:'100px'}}>{row.nama}</TableCell>

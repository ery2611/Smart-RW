...
export default function Detail2() {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-title" sx={{ textAlign: 'center', color: '#00A9AD' }}>
          Kirim Laporan
        </DialogTitle>
        <DialogContent>
        ...
        <DialogActions sx={{ justifyContent: 'center', paddingBottom: '16px' }}>
          <Button onClick={handleClose} sx={{ color: '#00A9AD' }}>Batal</Button>
          <Button variant="contained" onClick={handleClose} sx={{ bgcolor: '#00A9AD', color: '#fff' }}>
            Kirim Laporan
          </Button>
        </DialogActions>
      </Dialog>

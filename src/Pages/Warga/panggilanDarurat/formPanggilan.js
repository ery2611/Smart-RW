              ...
              <Card sx={{ width: "85%", borderRadius: "12px" }}>
                ...
                <Box sx={{ width: "95%", mt: 1, ml: 1, textAlign: "left" }}>
                  ...
                  >
                    ...
                    >
                        <Typography variant="body1" sx={{color:'#A0A1A4', mt:1}}>Jenis Panggilan</Typography>
                    ...
                    >
                        <Typography variant="body1" sx={{color:'#A0A1A4'}}>Petugas Yang Dipilih</Typography>
                        <Typography variant="body1">Richard Testnama</Typography>
                        {/* diambil dari nama petugas */}
                        <Typography variant="body1" sx={{color:'#A0A1A4'}}>Petugas Keamanan</Typography>
                    ...
                    sx={{
                        ...
                        <Typography variant="body1" color="#333333">: Keamanan</Typography>
                    ...
                    >
                        <Typography variant="body1" sx={{mt:4}}>Richard Testnama</Typography>
                        {/* diambil dari nama petugas */}
                        <Typography variant="body1" sx={{color:'#A0A1A4'}}>Petugas Keamanan</Typography>
                        {/* diambil dari jenis petugas */}
                    </Box>
